...
const data: {cite: string, author: string}[] = [
  ...
  {cite: `La faculté de se mettre dans la peau des autres et de réfléchr à la manière dont on agirait à leur place est très utile si on veut apprendre à aimer quelqu'un.`, author: `Dalai Lama`},
  ...
  {cite: `L'humour a non seulement quelque chose de libérateur, mais encore quelque chose de sublime et d'élèvé.`, author: `Sigmund Freud`},
  ...
  {cite: `On ne devrait vivre que pour le plaisir. Rien ne viellit comme le bonheur.`, author: `Oscar Wilde`},
  ...
  {cite: `Un des bonheur de l'amitié, c'est de savoir à qui confier un secret.`, author: `Alessandro Mansoni`},
  ...
  {cite: `Sans la musique, la vie serait une erreur.`, author: `Nietzsche`},
  ...
  {cite: `Les grandes choses peuvent se manifester par de petit signes.`, author: `Freud`},
